...
import net.narrnouille.cobblemoncasino.item.custom.*;
...
public class ModItems {
    ...
    private static ChipItem createChipItem(String name) {
        long value = CobblemonCasino.CONFIG.generalConfig.getChipValue(name);
        return new ChipItem(new Item.Properties(), value);
    }

    public static void registerModItems(IEventBus eventBus) {
        ITEMS.register(eventBus);
        CobblemonCasino.LOGGER.info("Registering Mod Items for " + CobblemonCasino.MOD_ID);
    }
}
