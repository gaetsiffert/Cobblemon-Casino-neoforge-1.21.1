...
import net.narrnouille.cobblemoncasino.network.c2s_handlers.blackjack.BlackjackActionReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.blackjack.ChangeBlackjackBetIndexReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.chip_table.ChipTableConvertReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.common.BetScreenReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.common.DoBetReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.common.DoWithdrawReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.common.MenuScreenReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.common.ReturnToMachineScreenReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.common.WithdrawScreenReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.slots.ChangeBetBaseReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.slots.ChangeLinesModeReceiver;
import net.narrnouille.cobblemoncasino.network.c2s_handlers.slots.DoSpinReceiver;
...
import net.narrnouille.cobblemoncasino.network.s2c_handlers.BlackjackStateReceiver;
import net.narrnouille.cobblemoncasino.network.s2c_handlers.MachineBalanceReceiver;
import net.narrnouille.cobblemoncasino.network.s2c_handlers.MenuScreenSettingsReceiver;
import net.narrnouille.cobblemoncasino.network.s2c_handlers.MoneyValuesSyncReceiver;
import net.narrnouille.cobblemoncasino.network.s2c_handlers.SlotConfigSyncReceiver;
import net.narrnouille.cobblemoncasino.network.s2c_handlers.SpinResultReceiver;
...
public final class CobblemonCasinoPackets {

    private CobblemonCasinoPackets() {}

    public static void registerPayloads(RegisterPayloadHandlersEvent event) {
        PayloadRegistrar registrar = event.registrar(CobblemonCasino.NETWORK_VERSION);
