...
public class ModSounds {
    private static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(Registries.SOUND_EVENT, CobblemonCasino.MOD_ID);
    ...
    public static void registerSounds(IEventBus eventBus) {
        ...
        CobblemonCasino.LOGGER.info("Registering Mod Sounds for " + CobblemonCasino.MOD_ID);
    }

    private static ResourceLocation id(String name) {
        return ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, name);
    }
}
