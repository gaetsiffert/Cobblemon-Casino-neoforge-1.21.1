...
import net.narrnouille.cobblemoncasino.games.chip_table.ChipTableConversionMode;
...
public class ChipTableScreen extends AbstractContainerScreen<ChipTableScreenHandler> {
    ...
    protected void init() {
        ...
        if (!this.menu.isWalletMode()) {
            ...
            this.addRenderableWidget(new CommonButton(baseX + BUTTON_ROW_X + MODE_BUTTON_WIDTH + BUTTON_GAP, baseY + BUTTON_ROW_Y,
                    ...
                    b -> CobblemonCasinoPackets.sendToServer(new ChipTableConvertC2SPayload(this.menu.getTablePos(), this.selectedMode,
                            parseCobbledollarAmount())),
                    Component.translatable("button.cobblemoncasino.convert")));

            this.cobbledollarAmountBox = new EditBox(this.font, baseX + 68, baseY + 34, 99, 12,
                    Component.translatable("gui.cobblemoncasino.chip_table.cobbledollar_amount"));
    ...
    protected void renderLabels(GuiGraphics context, int mouseX, int mouseY) {
        ...
        if (!this.menu.isWalletMode()) {
            if (this.selectedMode == ChipTableConversionMode.FROM_COBBLEDOLLAR) {
                context.drawString(this.font, Component.translatable("gui.cobblemoncasino.chip_table.cobbledollar_amount"),
                        7, 37, 0xFFFFFF, false);
            }
    ...
    private Component modeText() {
        return Component.translatable("gui.cobblemoncasino.chip_table.mode." + this.selectedMode.name().toLowerCase());
    }
    ...
    private void renderCurrencyValuePanel(GuiGraphics context) {
        ...
        context.drawString(this.font, Component.translatable("gui.cobblemoncasino.chip_table.currency_values"),
        ...
        for (ChipTableExchange.ValueEntry entry : entries) {
            ...
            context.drawString(this.font, Component.translatable("gui.cobblemoncasino.chip_amount",
