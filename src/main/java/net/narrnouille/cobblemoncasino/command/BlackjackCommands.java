...
import net.narrnouille.cobblemoncasino.games.blackjack.BlackjackUtils;
...
public final class BlackjackCommands {
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> buildSubcommand() {
        return Commands.literal("blackjack")
    ...
    private static int executeLeaderboard(CommandContext<CommandSourceStack> context, String key) {
        ...
        Component msg = BlackjackUtils.getLeaderboardText(context.getSource().getServer(), key);
