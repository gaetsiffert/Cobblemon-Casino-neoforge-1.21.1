...
public final class BlackjackUtils {
    ...
    public static Component getLeaderboardText(MinecraftServer server, String key) {
        ...
        Component titleLabel = switch (k) {
            case "highest_win" -> Component.translatable("command.cobblemoncasino.blackjack_highest_win");
            case "total_win" -> Component.translatable("command.cobblemoncasino.blackjack_total_won");
            case "total_lost" -> Component.translatable("command.cobblemoncasino.blackjack_total_lost");
            default -> Component.translatable("command.cobblemoncasino.blackjack_leaderboard");
        };
