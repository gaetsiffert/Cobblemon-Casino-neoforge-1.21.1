...
public class SlotUtils {
    ...
    public static Component getRatesText() {
        if (SlotReels.STRIPS == null || SlotReels.STRIPS.length < 3) {
            return Component.translatable("command.cobblemoncasino.slot_rates_not_loaded").withStyle(ChatFormatting.RED);
        }
        ...
        MutableComponent out = Component.literal("")
                .append(Component.translatable("command.cobblemoncasino.slots_rates").withStyle(ChatFormatting.UNDERLINE))
                .append("\n")
                .append(Component.translatable("command.cobblemoncasino.per_played_line").withStyle(ChatFormatting.GRAY));
        ...
        lines.add(new RateLine(Component.translatable("command.cobblemoncasino.slot_symbol.cherry_1"), cherry1, "x2"));
        lines.add(new RateLine(Component.translatable("command.cobblemoncasino.slot_symbol.cherry_2"), cherry2, "x3"));
        lines.add(new RateLine(Component.translatable("command.cobblemoncasino.slot_symbol.cherry_3"), cherry3, "x5"));
        ...
        for (SlotSymbol symbol : SlotSymbol.values()) {
            ...
            lines.add(new RateLine(Component.translatable("command.cobblemoncasino.slot_symbol.triple",
        ...
        out.append("\n")
                .append(Component.translatable("command.cobblemoncasino.modes").withStyle(ChatFormatting.GRAY))
                .append(Component.translatable("command.cobblemoncasino.slot_modes").withStyle(ChatFormatting.WHITE));
    ...
    public static Component getLeaderboardText(MinecraftServer server, String key) {
        ...
        if (valueFn == null) {
            return Component.translatable("command.cobblemoncasino.invalid_key").withStyle(ChatFormatting.RED);
        }
        ...
        if (rows.isEmpty()) {
            return Component.translatable("command.cobblemoncasino.no_leaderboard_entries").withStyle(ChatFormatting.GRAY);
        }
        ...
        Component titleLabel = switch (k) {
            case "highest_win" -> Component.translatable("command.cobblemoncasino.slots_highest_win");
            case "total_win" -> Component.translatable("command.cobblemoncasino.slots_total_won");
            case "total_lost" -> Component.translatable("command.cobblemoncasino.slots_total_lost");
            default -> Component.translatable("command.cobblemoncasino.slots_leaderboard");
        };
