...
import net.narrnouille.cobblemoncasino.block.custom.EventGachaMachineBlock;
import net.narrnouille.cobblemoncasino.block.custom.GachaMachineBlock;
import net.narrnouille.cobblemoncasino.block.custom.PlushiesGachaMachineBlock;
import net.narrnouille.cobblemoncasino.block.custom.PokemonGachaMachineBlock;
import net.narrnouille.cobblemoncasino.block.custom.SlotMachineBlock;
