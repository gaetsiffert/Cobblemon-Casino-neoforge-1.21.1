...
import net.narrnouille.cobblemoncasino.condition.GachaCurrencyCraftingEnabledCondition;
import net.narrnouille.cobblemoncasino.condition.MachinesCraftingEnabledCondition;
...
public class ModRecipeProvider extends RecipeProvider {
    ...
    private static void offerGachaCurrencyRecipes(RecipeOutput exporter) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.COPPER_COIN, 2)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "copper_coin"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.IRON_COIN, 2)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "iron_coin"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.GOLD_COIN, 2)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "gold_coin"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.DIAMOND_COIN, 4)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "diamond_coin"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.EVENT_COIN)
                ...
                .pattern(" # ")
                .unlockedBy(getHasName(Items.DIAMOND), has(Items.DIAMOND))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "event_coin"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.PRIMOGEM)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "primogem"));
    }
    ...
    private static void offerMachineRecipes(RecipeOutput exporter) {
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, ModBlocks.POKEMON_GACHA_MACHINE)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "pokemon_gacha_machine"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, ModBlocks.GACHA_MACHINE)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "gacha_machine"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, ModBlocks.PLUSHIES_GACHA_MACHINE)
                ...
                .pattern("WYW")
                .unlockedBy(getHasName(ModBlocks.POKEMON_GACHA_MACHINE), has(ModBlocks.POKEMON_GACHA_MACHINE))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "plushies_gacha_machine"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, ModBlocks.EVENT_GACHA_MACHINE)
                ...
                .pattern("EDE")
                .unlockedBy(getHasName(ModBlocks.POKEMON_GACHA_MACHINE), has(ModBlocks.POKEMON_GACHA_MACHINE))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "event_gacha_machine"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, ModBlocks.SLOT_MACHINE)
                ...
                .pattern("IRI")
                .unlockedBy(getHasName(Items.REDSTONE), has(Items.REDSTONE))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "slot_machine"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.BLACKJACK_TABLE)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "blackjack_table"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, ModBlocks.CHIP_TABLE)
                ...
                .pattern("G G")
                .unlockedBy(getHasName(Items.GOLD_INGOT), has(Items.GOLD_INGOT))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "chip_table"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, ModBlocks.CASINO_SCOREBOARD)
                ...
                .pattern("I I")
                .unlockedBy(getHasName(Items.REDSTONE), has(Items.REDSTONE))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "casino_scoreboard"));
    }
    ...
    private static void offerChipDecorationRecipes(RecipeOutput exporter) {
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.DECORATIVE_CHIP)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "decorative_chip"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.DECORATIVE_CHIP_STACK1)
                ...
                .pattern(" # ")
                .unlockedBy(getHasName(ModItems.RED_CHIP), has(ModItems.RED_CHIP))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "decorative_chip_stack1"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.DECORATIVE_CHIP_STACK2)
                ...
                .pattern(" # ")
                .unlockedBy(getHasName(ModItems.RED_CHIP), has(ModItems.RED_CHIP))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, "decorative_chip_stack2"));
    ...
    public static void offerDeconstruct(RecipeOutput exporter, RecipeCategory category, ItemLike output, ItemLike input, int count) {
        ShapelessRecipeBuilder.shapeless(category, output, count)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, getSimpleRecipeName(output) + "_from_" + getSimpleRecipeName(input)));
    }
    ...
    public static void offer2x2Recipe(RecipeOutput exporter, RecipeCategory category, ItemLike output, ItemLike input, int count) {
        ShapedRecipeBuilder.shaped(category, output, count)
                ...
                .pattern("##")
                .unlockedBy(getHasName(input), has(input))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, getSimpleRecipeName(output)));
    }
    ...
    public static void offerReversibleCompactingRecipesBetter(
        ...
        ShapelessRecipeBuilder.shapeless(reverseCategory, baseItem, 9)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, reverseId));
        ShapedRecipeBuilder.shaped(compactingCategory, compactItem)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(CobblemonCasino.MOD_ID, compactingId));
    }
