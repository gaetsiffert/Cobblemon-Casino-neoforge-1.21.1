...
import net.narrnouille.cobblemoncasino.config.npc.NpcTradeConfig;
...
public final class CasinoVillagerTrades {
    ...
    public static void register(VillagerTradesEvent event) {
        ...
        if (CobblemonCasino.CONFIG.prizeDealerNpc != null) {
            addConfiguredTrades(tradesByLevel, CobblemonCasino.CONFIG.prizeDealerNpc.trades);
        }
        if (CobblemonCasino.CONFIG.exchangerNpc != null) {
            addConfiguredTrades(tradesByLevel, CobblemonCasino.CONFIG.exchangerNpc.trades);
        }
    }
