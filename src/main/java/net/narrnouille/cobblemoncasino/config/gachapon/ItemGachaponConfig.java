    ...
    public void validatePostLoad() {
        if (pools.isEmpty()) {
            ...
            pools.put("common", List.of(
                    ...
                    new GachaEntry("cobblemoncasino:blue_chip", 5, 4),
                    new GachaEntry("cobblemoncasino:copper_chip", 1, 1),
            ...
            pools.put("uncommon", List.of(
                    ...
                    new GachaEntry("cobblemoncasino:copper_chip", 5, 2),
                    new GachaEntry("cobblemoncasino:iron_chip", 1, 1),
            ...
            pools.put("rare", List.of(
                    ...
                    new GachaEntry("cobblemoncasino:iron_chip", 5, 4),
                    new GachaEntry("cobblemoncasino:emerald_chip", 1, 1),
            ...
            pools.put("ultrarare", List.of(
                    ...
                    new GachaEntry("cobblemoncasino:emerald_chip", 5, 3),
                    new GachaEntry("cobblemoncasino:gold_chip", 1, 1),
            ...
            pools.put("legendary", List.of(
                    ...
                    new GachaEntry("cobblemoncasino:gold_chip", 5, 2),
                    new GachaEntry("cobblemoncasino:diamond_chip", 2, 2),
            ...
            pools.put("bonus", List.of(
                    ...
                    new GachaEntry("cobblemoncasino:iron_chip", 5, 3),
                    new GachaEntry("cobblemoncasino:emerald_chip", 1, 1),
                    new GachaEntry("minecraft:iron_ingot", 12, 12),
                    new GachaEntry("minecraft:copper_ingot", 16, 12),
                    ...
                    new GachaEntry("cobblemoncasino:copper_coin", 3, 16),
                    new GachaEntry("cobblemoncasino:iron_coin", 2, 8),
                    new GachaEntry("cobblemoncasino:gold_coin", 1, 2),
                    new GachaEntry("cobblemoncasino:diamond_coin", 1, 1)
            ));

            pools.put("event", List.of(
                    new GachaEntry("cobblemoncasino:event_coin", 1, 12),
                    new GachaEntry("cobblemoncasino:premier_gachapon", 1, 8),
                    new GachaEntry("cobblemoncasino:cherish_gachapon", 1, 4),
                    new GachaEntry("cobblemon:premier_ball", 8, 12),
