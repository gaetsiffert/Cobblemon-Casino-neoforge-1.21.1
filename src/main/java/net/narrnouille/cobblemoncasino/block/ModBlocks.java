package net.narrnouille.cobblemoncasino.block;

import net.narrnouille.cobblemoncasino.CobblemonCasino;
import net.narrnouille.cobblemoncasino.block.custom.*;
...
public class ModBlocks {
    private static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(CobblemonCasino.MOD_ID);
    private static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(CobblemonCasino.MOD_ID);
    // BLOCKS
    ...
    public static void registerModBlocks(IEventBus eventBus) {
        ...
        CobblemonCasino.LOGGER.info("Registering Mod Blocks for " + CobblemonCasino.MOD_ID);
    }
