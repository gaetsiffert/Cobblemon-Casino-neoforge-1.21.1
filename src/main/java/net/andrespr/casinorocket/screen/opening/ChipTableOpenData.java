...
public record ChipTableOpenData(BlockPos pos, boolean walletMode, List<ChipTableExchange.CurrencyValue> currencyValues,
                                boolean cobbledollarsAvailable) {

    public ChipTableOpenData(BlockPos pos, boolean walletMode) {
        this(pos, walletMode, List.of(), false);
    }
    ...
    private static ChipTableOpenData read(RegistryFriendlyByteBuf buf) {
        ...
        return new ChipTableOpenData(pos, walletMode, currencyValues, cobbledollarsAvailable);
    }
