...
public final class ModGuiTextures {
    ...
    private static ResourceLocation id(String path) {
        return ResourceLocation.fromNamespaceAndPath(CasinoRocket.MOD_ID, path);
    }
    ...
    public static final ResourceLocation LINES_LAYOUT =
            ResourceLocation.fromNamespaceAndPath(CasinoRocket.MOD_ID, "textures/gui/common/misc/lines_layout.png");
    ...
    public static final ResourceLocation REELS =
            ResourceLocation.fromNamespaceAndPath(CasinoRocket.MOD_ID, "textures/gui/common/misc/reels.png");
