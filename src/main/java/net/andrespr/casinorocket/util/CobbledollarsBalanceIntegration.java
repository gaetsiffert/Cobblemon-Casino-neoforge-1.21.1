...
public final class CobbledollarsBalanceIntegration {
    ...
    public static boolean deposit(Player player, long amount) {
        ...
        try {
            ...
            CasinoRocket.LOGGER.warn("Could not deposit CobbleDollars.", exception);
            return false;
        }
    }
    ...
    public static boolean withdraw(Player player, long amount) {
        ...
        try {
            ...
            CasinoRocket.LOGGER.warn("Could not withdraw CobbleDollars.", exception);
            return false;
        }
    }
    ...
    private static boolean resolveMethods() {
        ...
        try {
            ...
            CasinoRocket.LOGGER.warn("Could not resolve CobbleDollars player balance integration.", exception);
            return false;
        }
    }
}
